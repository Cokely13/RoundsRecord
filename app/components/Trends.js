...
import { VictoryPie, VictoryLabel, VictoryAxis, VictoryLine } from "victory";
    ...
    return (
      <svg style={styles.parent} viewBox="0 0 450 350">
        ...
        <VictoryLabel x={25} y={24} style={styles.title}
          text="Trend Line"
        />
        <VictoryLabel x={25} y={24} style={styles.labelOne}
          text={"Drinks Bought Ryan"}
        />
        <VictoryLabel x={425} y={55} style={styles.labelTwo}
          text={"Drinks Bought Scott"}
        />
